...
function merge(defaults, route, options) {
  ...
  if (options.url === "/graphql") {
    if (defaults && ((_a5 = defaults.mediaType.previews) == null ? void 0 : _a5.length)) {
...
function parse(options) {
  ...
  if (!isBinaryRequest) {
    ...
    if (url.endsWith("/graphql")) {
      if ((_a5 = options.mediaType.previews) == null ? void 0 : _a5.length) {
...
function fetchWrapper(requestOptions) {
  ...
  const parseSuccessResponseBody = ((_a5 = requestOptions.request) == null ? void 0 : _a5.parseSuccessResponseBody) !== false;
...
var Octokit = class {
  ...
  static plugin(...newPlugins) {
    ...
    const NewOctokit = (_a5 = class extends this {
    }, __publicField(_a5, "plugins", currentPlugins.concat(
...
function throttling(octokit, octokitOptions) {
  ...
  state.retryLimiter.on("failed", async function(error, info) {
    ...
    const { wantRetry, retryAfter = 0 } = await async function() {
      ...
      if (error.response.headers != null && error.response.headers["x-ratelimit-remaining"] === "0" || (((_a5 = error.response.data) == null ? void 0 : _a5.errors) ?? []).some(
...
async function auth3(state, options = {}) {
  ...
  if (options.type === "refresh") {
    ...
    await ((_a5 = state.onTokenCreated) == null ? void 0 : _a5.call(state, state.authentication, {
      type: options.type
    }));
  }
...
<p>Your token is: <strong>${token2}</strong>. Copy it now as it cannot be shown again.</p>`
    ...
    if (route === routes.getToken) {
      const token2 = (_a5 = headers.authorization) == null ? void 0 : _a5.substr("token ".length);
      if (!token2) {
        throw new Error(
...
}, __publicField(_a3, "VERSION", VERSION13), _a3);
...
}, __publicField(_a4, "VERSION", VERSION14), _a4);
